...
bool decode_wiegand(uint32_t top, uint32_t mid, uint32_t bot, int n) {
    ...
    if (n > 0) {
        ...
        PrintAndLogEx(INFO, "正在从位%d扫描到%d...", scan_start, scan_end);
