...
static bool TestAuth(void) {
    ...
    PrintAndLogEx(SUCCESS, "认证............. ( %s )", (res) ? _GREEN_("ok") : _RED_("fail"));
    return res;
}
...
static bool TestMAC(void) {
    ...
    PrintAndLogEx(SUCCESS, "通道 MAC...... ( %s )", (res) ? _GREEN_("ok") : _RED_("fail"));
    return res;
}
...
static bool TestEncDec(void) {
    ...
    PrintAndLogEx(SUCCESS, "通道 EncDec... ( %s )", (res) ? _GREEN_("ok") : _RED_("fail"));
    return res;
}
...
bool CIPURSETest(bool verbose) {
    ...
    PrintAndLogEx(INFO, "---------------------------");
    PrintAndLogEx(SUCCESS, "测试 ( %s )", (res) ? _GREEN_("ok") : _RED_("fail"));
