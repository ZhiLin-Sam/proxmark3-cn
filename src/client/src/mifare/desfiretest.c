...
static bool TestCMACSubkeys(void) {
    ...
    PrintAndLogEx(INFO, "CMAC 子密钥...... ( %s )", (res) ? _GREEN_("ok") : _RED_("fail"));
    return res;
}
...
static bool TestEV2SessionKeys(void) {
    ...
    PrintAndLogEx(INFO, "EV2会话密钥.. ( %s )", (res) ? _GREEN_("ok") : _RED_("fail"));
    return res;
}
...
static bool TestEV2IVEncode(void) {
    ...
    PrintAndLogEx(INFO, "EV2 IV计算....... ( %s )", (res) ? _GREEN_("ok") : _RED_("fail"));
    return res;
}
...
static bool TestEV2MAC(void) {
    ...
    PrintAndLogEx(INFO, "EV2 MAC计算...... ( %s )", (res) ? _GREEN_("ok") : _RED_("fail"));
    return res;
}
...
static bool TestTransSessionKeys(void) {
    ...
    PrintAndLogEx(INFO, "传输会话密钥 ( %s )", (res) ? _GREEN_("ok") : _RED_("fail"));
    return res;
}
...
static bool TestLRPPlaintexts(void) {
    ...
    PrintAndLogEx(INFO, "LRP 明文........ ( %s )", (res) ? _GREEN_("ok") : _RED_("fail"));
    return res;
}
...
static bool TestLRPUpdatedKeys(void) {
    ...
    PrintAndLogEx(INFO, "LRP 更新密钥...... ( %s )", (res) ? _GREEN_("ok") : _RED_("fail"));
    return res;
}
...
static bool TestLRPEval(void) {
    ...
    PrintAndLogEx(INFO, "LRP 评估.......... ( %s )", (res) ? _GREEN_("ok") : _RED_("fail"));
    return res;
}
...
static bool TestLRPIncCounter(void) {
    ...
    PrintAndLogEx(INFO, "LRP 递增计数器... ( %s )", (res) ? _GREEN_("ok") : _RED_("fail"));
    return res;
}
...
static bool TestLRPEncode(void) {
    ...
    PrintAndLogEx(INFO, "LRP 编码........ ( %s )", (res) ? _GREEN_("ok") : _RED_("fail"));
    return res;
}
...
static bool TestLRPDecode(void) {
    ...
    PrintAndLogEx(INFO, "LRP 解码........ ( %s )", (res) ? _GREEN_("ok") : _RED_("fail"));
    return res;
}
...
static bool TestLRPSubkeys(void) {
    ...
    PrintAndLogEx(INFO, "LRP 子密钥....... ( %s )", (res) ? _GREEN_("ok") : _RED_("fail"));
    return res;
}
...
static bool TestLRPSessionKeys(void) {
    ...
    PrintAndLogEx(INFO, "LRP 会话密钥...... ( %s )", (res) ? _GREEN_("ok") : _RED_("fail"));
    return res;
}
